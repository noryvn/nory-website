...
<div>
	...
	>
		...
		<input placeholder="username" type="text" name="username" class="input input-bordered" bind:value={username}>
		{#if invalidUsername}
		...
		<div class="input-group">
			<input placeholder="Nama mu" type="text" name="name" class="input input-bordered grow" bind:value={name}>
		...
		<button 
			{disabled}
			class:loading 
			class="btn btn-primary my-4" type="submit"
		> 
			Edit 
		</button>
	</form>
