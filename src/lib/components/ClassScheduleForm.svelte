...
<form class="form-control"
	on:submit|preventDefault={createSchedule}
>
	<h2 class="text-3xl">
		Jadwal Baru: 
	</h2>
	...
	<label class="label" for="startAt-input">
		Jam:
	</label>
	<input id="startAt-input" type="time" name="startAt" class="input input-bordered" bind:value={startAt}>

	<label class="label" for="day-input">
		Hari:*
	</label>
	<select 
		id="day-input"
	...
	<input id="duration-input" type="number" name="duration" class="input input-bordered" bind:value={duration}>
