			...
			<tr>
				<th>
					<div class="flex flex-row gap-2">
						<button on:click={() => sorterSwitch("day")}> Hari </button>
						{#if field === "day"}
							{#if asc}
				...
				<th>
					<div class="flex flex-row gap-2">
						<button on:click={() => sorterSwitch("startAt")}> Jam </button>
						{#if field === "startAt"}
							{#if asc}
								<Icon icon="ph:arrow-down" />
							{:else}
				...
				<th>
					<div class="flex flex-row gap-2">
						<button on:click={() => sorterSwitch("duration")}> Durasi(menit) </button>
						{#if field === "duration"}
							{#if asc}
								<Icon icon="ph:arrow-down" />
							{:else}
