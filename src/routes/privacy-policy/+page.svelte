<div class="p-8 container mx-auto flex flex-col gap-2">
	<h1 class="text-5xl font-bold">Privacy Policy</h1>

	<p>
		Kevin Falentio operates the https://nory.my.id website, which provides the SERVICE at no cost
		and is intended as it.
	</p>

	<p>
		This page is used to inform website visitors regarding our policies with the collection, use,
		and disclosure of Personal Information if anyone decided to use our Service, the Nory website.
	</p>
	...
	<p>
		...
		which is accessible at https://nory.my.id, unless otherwise defined in this Privacy Policy.
	</p>

	<h2 class="text-3xl font-bold mt-2">Information Collection and Use</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Log Data</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Cookies</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Service Providers</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Security</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Links to Other Sites</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Children's Privacy</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Changes to This Privacy Policy</h2>
	...
	<h2 class="text-3xl font-bold mt-2">Contact Us</h2>

	<p>
		If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact me
		at <a href="mailto:nory@falentio.com" class="link link-primary">nory@falentio.com</a>.
	</p>
</div>
